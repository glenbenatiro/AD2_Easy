...
void AD2_Easy::setDir(int port, bool dir)
{
...
void AD2_Easy::write(int port, bool state)
{
...
void AD2_Easy::writeAll(unsigned int cmd)
{
	FDwfDigitalIOOutputSet(hdwf, cmd);
}

void AD2_Easy::write(std::string ports, unsigned int cmd)
{
	std::vector<int> vect;
...
void AD2_Easy::strToArr(std::string ports, std::vector<int> &x)
{
	int temp;
	std::string substr;
...
unsigned int AD2_Easy::read(std::string ports)
{
...
unsigned int AD2_Easy::readDirAll()
{
